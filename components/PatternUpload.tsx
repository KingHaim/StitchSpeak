      ...
      {selectedCount === 0 ? (
        ...
        >
          <div 
            ...
            onDrop={onDrop}
          >
            <span className={`flex h-11 w-11 items-center justify-center overflow-visible rounded-full transition-colors ${isDragging ? 'bg-brand-200 text-brand-700' : 'bg-brand-100 text-brand-500 group-hover:bg-brand-200 group-hover:text-brand-600'}`}>
