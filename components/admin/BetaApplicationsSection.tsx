...
const attributionLabel = (item: AdminBetaApplication) => [item.utmSource, item.utmMedium, item.utmCampaign].filter(Boolean).join(' / ') || 'Direct / unknown';
